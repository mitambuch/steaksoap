...
const variantStyles: Record<NonNullable<ButtonProps['variant']>, string> = {
  primary:
    'bg-accent text-on-accent border border-fg/20 hover:border-fg/40 hover:shadow-[0_0_30px_color-mix(in_srgb,var(--color-accent)_40%,transparent)] hover:brightness-90 active:scale-[0.97]',
  secondary:
