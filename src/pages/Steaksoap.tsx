...
export default function Steaksoap() {
  ...
  return (
    <>
      <SeoHead
        title="steaksoap — Original Template"
        description="The original steaksoap showcase page. Browse the template that powers your project."
      />
